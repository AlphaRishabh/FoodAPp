                                                ...
                                                <div  >
                                                    {arrayData.Order_date ? <div className='m-auto mt-5 text-light'>
                                                        ...
                                                        <div className='col-12 col-md-6 col-lg-3' >
                                                            <div className="card mt-3 " style={{ width: "16rem", maxHeight: "360px",height:"280px" }}>
                                                                <img src="https://i.ytimg.com/vi/qZuWQNVl9zY/maxresdefault.jpg" className="card-img-top" alt=".." style={{ height: "160px", objectFit: "fill" }} />
                                                                <div className="card-body">
                                                                    <h5 className="card-title" style={{borderStyle:"ridge", borderRadius:"10px"}}><center>{arrayData.name}</center></h5>
